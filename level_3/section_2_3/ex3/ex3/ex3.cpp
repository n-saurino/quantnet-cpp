...
int main()
{
    ...
    std::cin >> y;
    Point pnt_2(x, y);
    // Constructor is called once, Copy Constructor is called once 
    ...
    // pnt_2.SetX(x);
    // pnt_2.SetY(y);
    // Constructor is called 2 times and the destructor is called 3 times

    std::cout << "The distance between " << pnt_1.ToString() << " and the origin is: " << pnt_1.Distance() << "\n";
