...
Saurino::CAD::Line::Line(): p1(), p2() {
	std::cout << "Line Colon Constructor Called\n";
}

Saurino::CAD::Line::Line(Point& new_p1, Point& new_p2): p1(new_p1), p2(new_p2) {
	std::cout << "Line Colon Copy Constructor Called!\n";
}

Saurino::CAD::Line::Line(float new_p1x, float new_p1y, float new_p2x, float new_p2y): p1(new_p1x, new_p1y), p2(new_p2x, new_p2y) {
